...
#      user_1_email_writer text,
#      user_2_email_get text,
#      date text,
#      post_id int,
#      comment_id int,
#      notification text,
...
#delete record
# cursor.execute("""DELETE FROM messages WHERE user_email_writer = 'dorm369258@gmail.com' """)
# cursor.execute("""DELETE FROM friend_requests WHERE user_1_email_writer = 'dorm369@gmail.com' """)
# cursor.execute("""DELETE FROM tags WHERE post_id = 1 """)
# cursor.execute("""DELETE FROM pictures WHERE post_id = 1 """)
# cursor.execute("""DELETE FROM users WHERE email = 'dorm123456789@gmail.com' """)
# cursor.execute("""DELETE FROM users WHERE email = 'dorm369258@gmail.com' """)
# cursor.execute("""DELETE FROM friends WHERE user_1_email = 'dorm369258@gmail.com' """)
# cursor.execute("""DELETE FROM friends WHERE user_1_email = 'dorm369@gmail.com' """)

# save as a row in the db
# data = (5,)
# cursor.execute('INSERT INTO table_name (rowid) VALUES (?)', data,)


# # query the database all with primary key
...
# add a row with all data
# cursor.execute("""INSERT INTO messages VALUES ('dorm369258@gmail.com', 'dorm369@gmail.com')""")
# cursor.execute("""INSERT INTO friends VALUES ('dorm369@gmail.com', 'dorm369258@gmail.com')""")
# cursor.execute("""INSERT INTO comments VALUES ('dorm369258@gmail.com', 'dorm369@gmail.com', 's', 10)""")

# Execute a SELECT query to retrieve a specific column from a specific row
# cursor.execute("UPDATE users SET profile_picture_path = 'front/static/assets/data/users/dorm123456@gmail.com/profile picture/profile picture.jpg' WHERE email = 'dorm123456@gmail.com'")
